...
public final class VCardResultParser extends ResultParser {
	...
	static List<List<String>> matchVCardPrefixedField(CharSequence prefix,
		...
		while (i < max) {
			...
			i = matchVCardPrefixedFieldRefactor(rawText, i, quotedPrintable);
			...
			if (i < 0) {
				...
				i = matchVCardPrefixedFieldRefactor2(matches, i, metadata, valueType, element);
			} else {
				i++;
			}
	...
	private static int matchVCardPrefixedFieldRefactor2(List<List<String>> matches, int i, List<String> metadata,
			String valueType, String element) {
	...
	private static int matchVCardPrefixedFieldRefactor(String rawText, int i, boolean quotedPrintable) {
